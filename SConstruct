...
env = Environment(tools = ['clang', 'clangxx', 'link'],
  CPPPATH=['.', 'tegra_mmapi', 'live555/include', 'glm', 'glatter/include', 'glatter/include/glatter', 'imgui', '/usr/include/drm', '/usr/src/tegra_multimedia_api/include', '/usr/src/tegra_multimedia_api/argus/include', '/usr/local/include/opencv4'],
  CPPFLAGS=['-g', '-Wall'],
...
env.Program(
  ...
  LIBS=['z', 'stdc++', 'boost_chrono', 'boost_system', 'GLESv2', 'EGL', 'dl', 'pthread', 'hidapi-hidraw', 'udev', 'nvargus', 'nvbuf_utils', 'v4l2', 'opencv_core', 'opencv_imgproc', 'opencv_calib3d', 'opencv_aruco']
)
